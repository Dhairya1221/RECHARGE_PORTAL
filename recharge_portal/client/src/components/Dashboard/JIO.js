...
const product4 = {
  company:"JIO",
  description:"100 SMS/PERDAY, UNLIMITED CALLING, 2GB INTERNET/PERDAY, 120 DAYS VALIDITY",
  price:2.0,
  phone:user.phone
}
...
const product5 = {
  company:"JIO",
  description:"100 SMS/PERDAY, 30 DAYS VALIDITY",
  price:2.0,
  phone:user.phone
}
...
const product11 = {
  ...
  phone:user.phone
   ...
   return (
    ...
    <h1 className="JIO">JIO</h1>
    <div className="textbox_phone">
        
        <input placeholder="PHONE" type="phone" name = "phone" value = {user.phone}  onChange= {handleChange} autoComplete="off" required="required" />  
    </div>
